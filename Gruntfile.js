module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    assemble: {
      ...
      dist: {
        options: {
          partials: ['src/layouts/partials/*.html'],
    ...
    copy: {
      dist: {
        files: [
          ...
          {expand:true, cwd: 'libs/modernizr/', src: 'modernizr.js', dest: 'dist/assets/js', filter:'isFile'}
        ]
      }
    },
    ...
    uglify: {
      dist: {
        files: {
          'dist/assets/js/all.js': ['libs/jquery/dist/jquery.js', 'libs/foundation/js/foundation.js', 'src/assets/js/*']
        }
      }
    },
